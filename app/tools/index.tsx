  ...
  },
  {
    ...
    tools: [
      ...
      },
      {
        ...
        description: "Identify co-occurring conditions and get LTD-relevant flags for your child's profile.",
        cta: 'Take quiz',
        route: '/disability-quiz',
        accentColor: COLORS.mintAccent,
      },
      {
        icon: '🔍',
        title: 'ICD Support Quiz',
        description: 'Find the ICD-10 codes to discuss with your doctor for the PMIP form.',
        cta: 'Take quiz',
        route: '/icd-quiz',
        accentColor: COLORS.yellowAccent,
      },
