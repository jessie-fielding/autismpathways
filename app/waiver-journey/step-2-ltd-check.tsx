  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <Text style={styles.heading}>Likelihood of Timely Discharge</Text>
        <Text style={styles.text}>This assessment determines if your child could be cared for in a medical facility.</Text>
      </ScrollView>
