...
export default function IEPScreen() {
  ...
  // Load flagged observations (global, not per-child) independently so they
  // always appear even if activeChild hasn't resolved yet.
  ...
  const loadData = async () => {
    // Always load flagged observations (stored globally, not per-child)
    loadFlagged();
    ...
    Alert.alert(
      ...
      [
        ...
        { text: 'Clear Flags', style: 'destructive', onPress: async () => {
          // Clear all flagged observations (they are stored globally, not per-child)
          await AsyncStorage.setItem('ap_iep_flagged_obs', JSON.stringify([]));
          // Also clear iepFlag on all observations in the main obs store
          const raw = await AsyncStorage.getItem('ap_observations');
          if (raw) {
            const obs = JSON.parse(raw);
            const updated = obs.map((o: any) => ({ ...o, iepFlag: false }));
            await AsyncStorage.setItem('ap_observations', JSON.stringify(updated));
          }
          setFlagged([]);
        }},
      ]
...
const cs = StyleSheet.create({
  ...
  setupBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.lavender, paddingVertical: SPACING.sm, paddingHorizontal: SPACING.md, borderRadius: RADIUS.md },
  ...
  addBtn: { backgroundColor: COLORS.purple, padding: SPACING.md, borderRadius: RADIUS.md, alignItems: 'center', marginBottom: SPACING.md, ...SHADOWS.sm },
  ...
  goObsBtnText: { color: COLORS.purple, fontWeight: 'bold' },
  ...
  scriptIconBox: { width: 36, height: 36, borderRadius: RADIUS.md, backgroundColor: COLORS.lavender, alignItems: 'center', justifyContent: 'center', marginRight: SPACING.md },
  ...
  scriptBox: { backgroundColor: COLORS.lavender, padding: SPACING.md, borderRadius: RADIUS.md },
  ...
  scriptCopy: { color: COLORS.purple, fontWeight: 'bold', marginTop: SPACING.md, textAlign: 'right' },
  ...
  goalProgressWrap: { height: 8, backgroundColor: COLORS.lavender, borderRadius: 4, overflow: 'hidden', marginBottom: SPACING.sm },
  goalProgressBar: { height: '100%', backgroundColor: COLORS.lavender },
  goalProgressFill: { height: '100%', backgroundColor: COLORS.purple },
  ...
  goalBtn: { paddingHorizontal: SPACING.md, paddingVertical: SPACING.sm, borderRadius: RADIUS.sm, backgroundColor: COLORS.lavender, marginRight: SPACING.sm },
  ...
  archiveToggleText: { color: COLORS.purple, fontWeight: 'bold' },
  // Meeting Cards
  ...
  attendeeChip: { backgroundColor: COLORS.lavender, paddingHorizontal: SPACING.sm, paddingVertical: 4, borderRadius: RADIUS.sm, marginRight: SPACING.sm, marginBottom: SPACING.sm },
  ...
  input: { backgroundColor: COLORS.lavender, padding: SPACING.md, borderRadius: RADIUS.md, fontSize: FONT_SIZES.md, marginBottom: SPACING.md },
  primaryBtn: { backgroundColor: COLORS.purple, padding: SPACING.lg, borderRadius: RADIUS.md, alignItems: 'center', marginTop: SPACING.md },
  primaryBtnText: { color: 'white', fontWeight: 'bold', fontSize: FONT_SIZES.md },
  gradeChip: { paddingHorizontal: SPACING.md, paddingVertical: SPACING.sm, borderRadius: RADIUS.pill, backgroundColor: COLORS.lavender, marginRight: SPACING.sm },
  gradeChipActive: { backgroundColor: COLORS.purple },
