        ...
        <View style={styles.content}>
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Some children who do not qualify under household income rules may still qualify through disability-related Medicaid pathways and waiver programs.
            </Text>
          </View>
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Next, we'll figure out whether your child has already been approved for long-term disability so we can guide you to the right path.
            </Text>
          </View>
        </View>
      </ScrollView>
