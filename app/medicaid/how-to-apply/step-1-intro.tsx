...
export default function MedicaidIntro() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>How to Apply for Medicaid</Text>
      </View>
      ...
      <ScrollView>
        <View style={styles.content}>
          ...
          <Text style={styles.text}>
            Medicaid is a health insurance program that can help cover medical costs for your child. Let's walk through the application process step by step.
          </Text>
        </View>
      </ScrollView>

      <View style={styles.buttons}>
        <TouchableOpacity style={[styles.button, styles.buttonPrimary]} onPress={() => router.push('/medicaid/how-to-apply/step-2-paperwork')}>
